...
const Footer = () => {
  return (
    <div className="w-full px-[4vw] py-[3vw] h-screen bg-zinc-100 text-zinc-900">
      <div className="flex justify-between h-full w-full gap-[2vw]">
        {/* left */}
        <div className="w-1/2 h-full pt-[4vw] flex flex-col justify-between">
            <div>
        ...
        <div className="w-1/2 h-full pt-[4vw] flex flex-col justify-between">
            ...
            <div className="w-full flex justify-between">
                <p className="text-zinc-400 text-medium">© ochi design 2025. <span className="underline">Legal Terms</span></p>
                <p className="text-zinc-400 text-medium ">Website by Obys</p>
            </div>    
